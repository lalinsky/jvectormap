...
jvm.WorldMap.prototype = {
  ...
  resize: function() {
    ...
    if (typeof this.params.minScale != 'undefined') {
      if (this.scale < this.params.minScale) {
        this.scale = this.params.minScale;
      }
    ...
    if (this.scale != curScale) {
      ...
      this.container.trigger('zoom.jvectormap', [this.scale/this.baseScale]);
    }
  },
